...
>>>>>>> 183252654cd60404ff9305cfbc4f21d6ef9b999c
...
ADD CONSTRAINT `fk_Activity_Administrator` FOREIGN KEY
(`idAdministrator`) REFERENCES `administrator`
(`idAdministrator`) ON
DELETE NO ACTION ON
UPDATE NO ACTION;
...
--
ALTER TABLE `comment`
ADD CONSTRAINT `fk_Comment_Activity1` FOREIGN KEY
(`idActivity`) REFERENCES `activity`
(`idActivity`) ON
DELETE NO ACTION ON
UPDATE NO ACTION,
ADD CONSTRAINT `fk_Comment_User1` FOREIGN KEY
...
ADD CONSTRAINT `fk_CreditCard_User1` FOREIGN KEY
(`idUser`) REFERENCES `user`
(`idUser`) ON
DELETE NO ACTION ON
UPDATE NO ACTION;
...
<<<<<<< HEAD
ADD CONSTRAINT `fk_Reservation_CreditCard1` FOREIGN KEY
(`idCreditCard`) REFERENCES `creditcard`
(`idCreditCard`) ON
DELETE NO ACTION ON
UPDATE NO ACTION;
=======
