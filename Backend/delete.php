...
if(isset($_SESSION['admin'])==null){ //Verifica se existe uma sessão de admin. Senão tiver entao é redirecionado para o login.php. Isto serve para bloquear o acesso atraves da url do browser
