...
session_start(); // session_start Verifica se existe uma sessão de admin. Senão tiver entao é redirecionado para o login.php. Isto serve para bloquear o acesso atraves da url do browser
...
$count = $sql->rowCount(); // Guardamos o numero de vezes que aparece o resultado da query numa variavel $count
